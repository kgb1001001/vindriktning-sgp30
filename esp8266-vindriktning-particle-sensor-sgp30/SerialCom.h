...
namespace SerialCom {
    constexpr static const uint8_t PIN_UART_RX = 13; // GPIO 13 is D7 - D2 on Wemos D1 Mini (original 4)
    constexpr static const uint8_t PIN_UART_TX = 15; // GPIO 15 is D8 - UNUSED (original 13)
